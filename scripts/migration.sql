-- ============================================================================
-- Erq Marketplace — PostgreSQL Schema Migration
...
VALUES ('admin-default', 'admin@gebeya.et', '$2a$10$dummy-hash-placeholder', 'Admin User', 'admin', 1)
ON CONFLICT (id) DO NOTHING;

-- System user for default agents
INSERT INTO users (id, email, password, full_name, role, verified)
VALUES ('system', 'system@gebeya.et', '$2a$10$dummy-hash-placeholder', 'System', 'admin', 1)
ON CONFLICT (id) DO NOTHING;

-- Default AI agents
INSERT INTO user_agents (id, user_id, name, role, instructions, color, is_active) VALUES
  ('agent-assistant', 'system', 'Erq Assistant', 'General Assistant', 'A helpful AI assistant for the Erq marketplace.', '#1a1a1a', 1),
  ('agent-writer', 'system', 'Content Writer', 'Content Creator', 'Specialized in writing and translation services.', '#444444', 1),
