  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        'shadow-[8px_8px_24px_rgba(0,0,0,0.06),inset_-4px_-4px_12px_rgba(0,0,0,0.02),inset_4px_4px_12px_rgba(255,255,255,0.6)]',
        className
      )}
...
export function DockIconHome({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
      strokeLinecap="round" strokeLinejoin="round" className={cn('w-full h-full', className)}>
