...
const TASK_SEQUENCES = [
  {
    status: "Reading your brief",
    lines: [
      "Checking your portfolio name...",
      "Reading your description and audience...",
      "Keeping only the proof you supplied...",
    ],
  },
  {
    status: "Building your brand system",
    lines: [
      "Pairing body and heading typography...",
      "Balancing the supplied color direction...",
      "Setting the portfolio visual rhythm...",
    ],
  },
  {
    status: "Composing your portfolio",
    lines: [
      "Organizing real projects and services...",
      "Writing editable section structure...",
      "Preparing responsive portfolio output...",
    ],
  },
];
  ...
  return (
    <div
      ...
      <div className="w-auto space-y-4">
        <div
          className="ml-2 flex items-center space-x-2 font-medium text-gray-600 dark:text-gray-300">
            ...
            <div>
              {visibleLines.map((line, index) => (
                <div
                  ...
                  <div
                    className="w-6 select-none pr-3 text-right text-gray-400 dark:text-gray-500">
                    {line.number}
                  </div>
